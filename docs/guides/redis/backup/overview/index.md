...
menu:
  docs_{{ .version }}:
    identifier: guides-rd-backup-overview
    name: Overview
...
The following diagram shows how Stash takes backup of a Redis database. Open the image in a new tab to see the enlarged version.

<figure align="center">
  <img alt="Redis Backup Overview" src="/docs/guides/redis/backup/overview/images/backup_overview.svg">
  <figcaption align="center">Fig: Redis Backup Overview</figcaption>
</figure>
...
The following diagram shows how Stash restores backed up data into a Redis database. Open the image in a new tab to see the enlarged version.

<figure align="center">
  <img alt="Database Restore Overview" src="/docs/guides/redis/backup/overview/images/restore_overview.svg">
  <figcaption align="center">Fig: Redis Restore Process Overview</figcaption>
</figure>
...
- Backup a standalone Redis database using Stash following the guide from [here](/docs/guides/redis/backup/standalone/index.md).
- Configure a generic backup template for all the Redis databases of your cluster using Stash Auto-backup by following the guide from [here](/docs/guides/redis/backup/auto-backup/index.md).
