...
- `spec.upgrade.targetVersion` refers to a [PostgresVersion](/docs/guides/postgres/concepts/catalog.md) CR that contains the Postgres version information where you want to upgrade.
